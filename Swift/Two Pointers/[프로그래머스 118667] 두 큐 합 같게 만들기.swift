...
//  Algorithm
//
//  Created by 김민 on 2023/09/21.
//

// 프로그래머스 118667 https://school.programmers.co.kr/learn/courses/30/lessons/118667

import Foundation

// pop, insert할 특정한 값을 구하기 -> 투포인터를 사용해 볼까
func solution(_ queue1:[Int], _ queue2:[Int]) -> Int {
    ...
    while (left <= right && right < array.count) { // 범위 지정, sum1을 기준으로 계산
        if sum1 < goal {
